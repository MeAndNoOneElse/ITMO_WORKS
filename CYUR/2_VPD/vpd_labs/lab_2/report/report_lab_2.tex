...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../matlab/graphs/angles/angle_50.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{../matlab/graphs/velocities/velocity_50.png}
...
На рис.~\ref{fig:comparison} приведено сравнение экспериментальных данных с результатами моделирования для угловой скорости и угла поворота для всех 18 уровней управляющего сигнала.

\begin{figure}[H]
    \centering
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/comparison/comparison_50.png}
        \caption{$U = +50\%$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/comparison/comparison_45.png}
        \caption{$U = +45\%$}
    \end{subfigure}
    \\[0.5cm]
    \begin{subfigure}{0.48\textwidth}
    ...
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/comparison/comparison_35.png}
        \caption{$U = +35\%$}
    \end{subfigure}
    \caption{Сравнение экспериментальных данных, аппроксимации и Simulink-модели (часть 1)}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/comparison/comparison_30.png}
        \caption{$U = +30\%$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/comparison/comparison_25.png}
        \caption{$U = +25\%$}
    \end{subfigure}
    \\[0.5cm]
    \begin{subfigure}{0.48\textwidth}
    ...
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/comparison/comparison_15.png}
        \caption{$U = +15\%$}
    \end{subfigure}
    \caption{Сравнение экспериментальных данных, аппроксимации и Simulink-модели (часть 2)}
\end{figure}

\begin{figure}[H]
    \centering
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/comparison/comparison_10.png}
        \caption{$U = +10\%$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/comparison/comparison_-10.png}
        \caption{$U = -10\%$}
    \end{subfigure}
    \\[0.5cm]
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/comparison/comparison_-15.png}
        \caption{$U = -15\%$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{$U = -20\%$}
    \end{subfigure}
    \caption{Сравнение экспериментальных данных, аппроксимации и Simulink-модели (часть 3)}
\end{figure}

\begin{figure}[H]
    \centering
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/comparison/comparison_-25.png}
        \caption{$U = -25\%$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/comparison/comparison_-30.png}
        \caption{$U = -30\%$}
    \end{subfigure}
    \\[0.5cm]
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/comparison/comparison_-35.png}
        \caption{$U = -35\%$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        ...
        \caption{$U = -40\%$}
    \end{subfigure}
    \caption{Сравнение экспериментальных данных, аппроксимации и Simulink-модели (часть 4)}
\end{figure}

\begin{figure}[H]
    \centering
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/comparison/comparison_-45.png}
        \caption{$U = -45\%$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/comparison/comparison_-50.png}
        \caption{$U = -50\%$}
    \end{subfigure}
    \caption{Сравнение экспериментальных данных, аппроксимации и Simulink-модели (часть 5)}
\end{figure}

На рис.~\ref{fig:sim_current} показан моделируемый переходный процесс тока в обмотке якоря для всех 18 уровней управляющего сигнала.

\begin{figure}[H]
    \centering
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/I_t/50.png}
        \caption{$U = +50\%$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/I_t/45.png}
        \caption{$U = +45\%$}
    \end{subfigure}
    \\[0.3cm]
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/I_t/40.png}
        \caption{$U = +40\%$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/I_t/35.png}
        \caption{$U = +35\%$}
    \end{subfigure}
    \\[0.3cm]
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/I_t/30.png}
        \caption{$U = +30\%$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/I_t/25.png}
        \caption{$U = +25\%$}
    \end{subfigure}
    \caption{Переходный процесс тока в обмотке якоря (часть 1)}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/I_t/20.png}
        \caption{$U = +20\%$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/I_t/15.png}
        \caption{$U = +15\%$}
    \end{subfigure}
    \\[0.3cm]
    \begin{subfigure}{0.45\textwidth}
        \includegraphics[width=\textwidth]{../matlab/graphs/I_t/10.png}
        \caption{$U = +10\%$}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \caption{$U = -20\%$}
    \end{subfigure}
    \caption{Переходный процесс тока в обмотке якоря (часть 2)}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        \caption{$U = -50\%$}
    \end{subfigure}
    \caption{Переходный процесс тока в обмотке якоря (часть 3)}
\end{figure}
\newpage
