# Программирование на Java - Лабораторная работа №6
...
### Запуск сервера
```bash
java -cp Server/target/classes:Shared/target/classes Server
```

### Запуск клиента
```bash
java -cp Client/target/classes:Shared/target/classes Client
```

### Запуск основного приложения
```bash
set FILE_NAME=<path_to_xml_file>
java -cp src Main
```